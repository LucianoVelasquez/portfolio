  ...
  return (
    <div className="hero min-h-screen  bg-base-200 z-20 herores">
      <div className="hero-content flex-col lg:flex-row-reverse z-10 ">
        <img  variants={textVariants} src="https://raw.githubusercontent.com/LucianoVelasquez/portfolio/main/src/components/Hero/avatar3.png" className="object-contain w-12 rounded-full xl:w-1/2  xl:mb-28 lg:w-80 lg:mb-28 imgres" />
      ...
      <motion.div className={hh2} variants={SilVariants} initial="initial" animate="animate">
